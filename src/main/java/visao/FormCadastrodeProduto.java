 ...
 */
public class FormCadastrodeProduto extends javax.swing.JFrame {

    private Produto objetoProduto;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormCadastrodeProduto.class.getName());
    public FormCadastrodeProduto() {
        initComponents();
        this.objetoProduto = new Produto();
        setDefaultCloseOperation(FormCadastrodeProduto.DISPOSE_ON_CLOSE);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new FormCadastrodeProduto().setVisible(true));
    }
